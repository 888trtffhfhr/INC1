 ...
 *
 */
public class DiscrollvableGreenLayout extends LinearLayout implements
		Discrollvable {
	...
	public void onDiscrollve(float ratio) {
		...
		if (ratio >= 0.5f) {
			...
			mGreenView1.setTextColor((Integer) mArgbEvaluator.evaluate(ratio,
					mBlackColor, mGreenColor));
			setBackgroundColor((Integer) mArgbEvaluator.evaluate(ratio,
					mGreenColor, mBlackColor));
		}
	}
}
